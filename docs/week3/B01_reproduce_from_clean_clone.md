...
这是 B31/B1 的正式复现命令记录。`B01` 是交付物编号，不是真实 STAR case 名；当前 README 推荐新的本地演示目录使用 `runs/week3_mock_full_demo`。
...
- clean clone 演示 commit: `f82ee15198966a1079b478902d53de594f14c634`
- clean clone 临时目录: `/Users/yanbochao/week3_B01_mock_clean_clone_20260727212651`
